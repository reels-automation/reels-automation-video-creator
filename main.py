...
def main():
    ...
    while True:
        ...
        list_of_videos = ["60seconds1.mp4", "60seconds2.mp4","60valorant.mp4",
                          "clash-vertical1.mp4", "clash-vertical2.mp4", "dbd.mp4",
                            "flappy-ai.mp4", "gettingoverit.mp4", "gta.mp4", "subway.mp4","subway2.mp4","subway3.mp4", "undertale1.mp4","undertale2.mp4"]
